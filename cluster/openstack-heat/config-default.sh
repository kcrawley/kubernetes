...
ENABLE_CLUSTER_MONITORING=${ENABLE_CLUSTER_MONITORING:-influxdb}

ENABLE_CLUSTER_LOGGING=${ENABLE_CLUSTER_LOGGING:-true}

ENABLE_CLUSTER_UI=${ENABLE_CLUSTER_UI:-true}

ENABLE_NODE_LOGGING=${ENABLE_NODE_LOGGING:-true}

LOGGING_DESTINATION=${LOGGING_DESTINATION:-elasticsearch}

ELASTICSEARCH_REPLICAS=${ELASTICSEARCH_REPLICAS:-1}
